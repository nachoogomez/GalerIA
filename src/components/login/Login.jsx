const Login = () => {
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl mt-6">
    ...
    <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <p href="#" className="text-xs text-center text-gray-500 uppercase hover:underline">or login
                with email</p>
