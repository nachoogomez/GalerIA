 ...
 * - Iconos de Redes Sociales con sus enlaces
            ...
            <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                ...
                <div className="flex -mx-2">
                    <a href="https://www.facebook.com/share/1F3KWRqu8b/" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
                      ...
                      <a href="https://github.com/" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
